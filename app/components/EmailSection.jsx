...
const EmailSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const options = {
      ...
      //body of request is JSON data we created above
      body: JSONdata,
    };
    ...
    >
      ...
      >
        ...
        <div className="flex flex-row gap-2 socials">
          <Link href="https://github.com/priyankads296/">
        ...
        <form className="flex flex-col" onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              ...
              required
              className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm px-2 py-2 rounded-lg block w-full"
            ></input>
          </div>
          <div className="mb-6">
            <label
